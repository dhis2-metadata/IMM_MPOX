...
![Vaccine administration by target groups](resources/image/epimpox_001)

The dataset includes a simple section on AEFIs disaggregated by seriousness. 

![AEFIs](resources/image/epimpox_002)
...
![Population by age and sex](resources/image/epimpox_004)
...
![Target population](resources/image/epimpox_005)
...
![Pre-immunisation questions](resources/image/eirmpox_004)
...
![Vaccine administration](resources/image/eirmpox_005)
...
![AEFI alert in the second event](resources/image/eirmpox_006)
...
![Automatic generation of a n event after the time interval. 28 days was selected as it is the recommended interval for the mpox JYNNEOS vaccine](resources/image/eirmpox_007)
...
![Schedule the next dose](resources/image/eirmpox_009)
...
![Scheduling an event](resources/image/eirmpox_008)
...
![Mpox dashboard](resources/image/epimpox_006)
