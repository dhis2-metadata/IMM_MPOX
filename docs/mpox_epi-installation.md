# MPOX EPI Installation Guide { #mpox-epi-installation}
...
2. Import into a DHIS2 instance with existing metadata (No other versions of MPOX EPIention tracker imported previously).
3. Update existing/older version of the MPOX EPIention tracker.
...
* MPOX EPI - Access
* MPOX EPI - Admin
* MPOX EPI - Data capture

By default, the following is assigned to these user groups

| Object              | User Groups                             | User Groups                                      |  User Groups                                        |
|---------------------|-----------------------------------------|--------------------------------------------------|-----------------------------------------------------|
|                     | MPOX EPI - Access                       | MPOX EPI - Admin                                 | MPOX EPI - Data capture                             |
